...
The [Deportation Data Project](https://deportationdata.org) is the most widely used effort at documenting arrests, detentions and removals in the immigration system.  Run by Graeme Blair of UCLA and David Hausman of Berkeley Law, the project and its lawyers began suing the federal government for individual level records about a decade ago and finally won access to some of the desired datasets, which they now make available to anyone on their website. It is actively updating information from Immigration and Customs Enforcement, or ICE.^[Customs and Border Patrol, or CBP, has not yet provided data that is compatible with the ICE data, and the immigration courts run by the Justice Department provide completely different datasets, which haven't yet been analyzed or cleaned by the project.]  As of this writing, the project posts original FOIA data for arrests, detentions and detainers through October 2025, and is trying to get the agency to correct its recent releases on removals and encounters.
...
There are more than 300,000 people covering about xxx arrests in the arrest data alone. Detentions -- people held in ICE facilities -- cover xx million individual detentions, as the federal government moves people from place to place.

The project itself allows users to filter and download the raw data, which is a great place to start for people who know how to program or can handle detailed and complicated datsets.

But before you delve into working on your own, consider whether some other sources might provide what your story needs. All of these sources start with the deportation project's original files, but provide different views of the data that might need your needs.
...
Two Rice University computer science students created a [live feed of news reported incidents](https://www.icemap.dev/), mapped to general regions
