...
The project has also been working on cleaning and simplifying the monthly immigration court case dockets from the Justice Department. In March 2026, they expected to release the data soon. It tells us more about the legitimate deportation system than ICE processing statistics, and has the advantage of being updated every month. However, there currently is no direct way to link the activities of the court to the activities within the Department of Homeland Security as they use different anonymized unique identifiers. 
