...
* [x] Add information on where arrested from detainer and first place of detention to the arrest table
* [x] Add most serious conviction code / category from the detention, detainer and old removal data. The best-case is detention, detainer might still have pending charge.
